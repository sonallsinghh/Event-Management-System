...
from event_management_system_app.forms import CategoryForm
...
def home(request):
    ...
    return render(request, 'event_management_system_app/home.html', context)
...
def create_category(request):
    if request.method == 'POST':
        ...
        form = CategoryForm()
    return render(request, 'event_management_system_app/create_category.html', {'form': form})
